...
class PopularBookPage extends StatelessWidget {
  const PopularBookPage({Key? key}) : super(key: key);
        ...
        if (state is BookLoaded) {
          return ListView.builder(
              ...
              itemCount: state.listbook
                  .where((e) => e.bookforu == false && e.popularbook == true)
                  .toList()
                  .length,
              itemBuilder: (BuildContext context, int index) {
                return BuildCardBook(
                  ...
                  image: state.listbook
                      .where(
                          (e) => e.bookforu == false && e.popularbook == true)
                      .toList()[index]
                      .image,
                  title: state.listbook
                      .where(
